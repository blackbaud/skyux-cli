...
Common Commands:
  ...
  test            Runs the both unit and end-to-end tests.
  e2e             Runs the end-to-end tests.
  watch           Runs unit tests and watches filesystem for changes.

Common Options:
  -launch         Which URL to launch during serve.
                    One of host (default), local, or none.
                    Ex: skyux serve -launch local

  -noServe        Stops the e2e command from automatically calling serve.
`);
